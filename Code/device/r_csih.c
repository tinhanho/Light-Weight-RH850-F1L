...
******************************************************************************/
extern volatile RCSIHStatusType RCSIHStatus = R_CSIH_SHUTDOWN;
uint8 shiftBits;
...
void intr_csih1ic_function( void )
{
    ...
    {
#ifdef R_CSIH_C1
        Osek_Com_Nm_IntHandler(RCSIH_TxSuccess,R_CSIH_C1);
#endif
    }
#endif
}
...
void intr_csih1ir_function( void )
{
    ...
    {
#ifdef R_CSIH_C1
        Osek_Com_Nm_IntHandler(RCSIH_RxSuccess,R_CSIH_C1);
#endif
    }
#endif
}
